...
@celery_app.task(name="generate_lecture_guided_summary_task")
def generate_lecture_guided_summary_task(lecture_id: str) -> None:
    from src.features.lectures.services.lecture_service import generate_guided_summary

    generate_guided_summary(UUID(lecture_id))
