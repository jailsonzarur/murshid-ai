...
router.include_router(create_user_router, prefix="/users")
router.include_router(update_user_router, prefix="/users")
router.include_router(update_user_role_router, prefix="/users")
router.include_router(delete_user_router, prefix="/users")
